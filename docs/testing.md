...
| Suite      | Scope                                                                                                                                                                                  |
| ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Acton      | BANK initial funding, FIFO allocation, partial/exact/cascading settlement, value conservation, fees, replay and races; DUEL matching, commit–reveal, timeouts, refunds and permissions |
...
The browser suite verifies interface and message construction without a seed phrase. Contract tests exercise full messages in an emulated TVM. The read-only chain smoke verifies deployed artifacts and the recorded BANK funding transaction. A broadcast two-wallet end-to-end test is deliberately not run in CI because it would require funded signing keys; release validation uses manually signed testnet transactions and explorer proofs instead.
