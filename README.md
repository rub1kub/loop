...
**LOOP запущен 5 августа 2026.** Пригласивший получает 5% с каждого подтверждённого взноса приглашённых — навсегда, из комиссии протокола; персональные ставки 10% сохраняются.
...
Команды соревнуются недельными сезонами. Основной счёт — сумма подтверждённых взносов участников в BANK за неделю; выплаты и DUEL видны отдельно и не подменяют этот показатель. Владелец настраивает название, описание, аватар, режим вступления и роли. Число участников не ограничено, но каждый человек одновременно состоит только в одной команде.

Профиль также собирает историю BANK и DUEL, статус PLUSH BRICK и подтверждения операций в одном месте. Победитель DUEL с подтверждённым PLUSH BRICK получает пул без комиссии DUEL; комиссия BANK от токена не зависит. Откупы выполняются вручную и публикуются с доказательствами. Купить: [dTrade](https://t.me/dtrade?start=1IPvnLpaEN_EQAJ40p3zlCoomgANMQ4u5eIktLMZtWP87GGKDKlyW_EZBwt) · [RedoTrade](https://t.me/redotrade?start=rubikub-EQAJ40p3zlCoomgANMQ4u5eIktLMZtWP87GGKDKlyW_EZBwt). На очередь BANK и шанс победы в DUEL кирпич не влияет.
