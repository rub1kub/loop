...
> LOOP работает в основной сети TON с настоящими GRAM. BANK — финансовая пирамида, и проект называет её так прямо: выплаты зависят от новых участников и могут остановиться навсегда. Контракты не проходили независимый аудит; границы полномочий владельца и все риски перечислены в [docs/no-audit-disclosure.md](docs/no-audit-disclosure.md).
...
- Контракты BANK и DUEL работают в основной сети TON с настоящими GRAM и не проходили независимый аудит: [docs/no-audit-disclosure.md](docs/no-audit-disclosure.md).
- LOOP не получает секретные фразы или закрытые ключи пользователей и не ведёт внутренний пользовательский баланс.
- В BANK владелец может на паузе вывести любой остаток сверх резерва хранения — включая средства, на которые рассчитывают открытые позиции, — но только в казначейство. Это видно в опубликованных исходниках и описано в раскрытии рисков. В DUEL запертые ставки владельцу недоступны.
