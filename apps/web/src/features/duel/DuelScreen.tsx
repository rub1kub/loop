      ...
      {status === 'idle' && !boostPanelOpen && (
        <details className="technical-details duel-rules">
          ...
          <div className="duel-rules-body">
            ...
            <p>
              После усиления оба подтверждают игру. Первый не выигрывает сразу: у второго есть время
              до конца таймера.
            </p>
            <p>
              Подтвердили оба — контракт выбирает победителя по текущим шансам. Подтвердил только
              один — после таймера выигрывает он. Не подтвердил никто — ставки возвращаются целиком,
              без комиссии.
            </p>
