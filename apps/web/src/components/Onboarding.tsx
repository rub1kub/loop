...
const stories = [
  ...
  },
  {
    ...
    title: 'Отдельный токен\nсообщества.',
    detail:
      'Сейчас PLUSH BRICK не меняет комиссию, очередь BANK и шанс в DUEL: LOOP только показывает отметку владельца. Режим без комиссии — планы, а не текущее правило.',
