      ...
      <main id="content">
        ...
        <section className="landing-plush" id="plush-brick">
          ...
          <div className="landing-section-copy" data-reveal>
            ...
            <p>
              Это отдельный токен экосистемы TON Suite. Сейчас LOOP только проверяет владение во
              внешнем кошельке и показывает отметку: комиссия одинакова для всех, выкуп не
              выполняется. Режим без комиссии для держателей — цель, для которой понадобится новый
              контракт.
            </p>
            <div className="landing-plush__steps">
              <div>
                <span>=</span>
                <p>Сейчас комиссия LOOP одинакова для всех</p>
              </div>
              <div>
                <span>↻</span>
                <p>Режим без комиссии и выкуп — планы, а не текущее правило</p>
              </div>
              <div>
                <span>✓</span>
                <p>Владение подтверждается внешним кошельком</p>
              </div>
            </div>
