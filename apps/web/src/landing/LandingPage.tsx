    ...
    <div className="landing">
      ...
      <main id="content">
        <section className="landing-hero" id="top">
          ...
          <div className="landing-hero__art" aria-label="BANK и DUEL образуют LOOP">
        ...
        <section className="landing-statement">
          <div data-reveal>
            <span className="landing-eyebrow">НЕ КОШЕЛЁК</span>
            <h2>
              Здесь не хранят средства. <span>Здесь участвуют.</span>
            </h2>
            <p>
              TON Connect нужен только для подтверждения действий, проверки активов и получения
              выплат.
            </p>
          </div>
        </section>
